 ...
 * @return iterator to the destination
...
/** 
 * @brief Removes all duplicate (duplicate = not the first) elements from a sorted sublist [_begin.._end) -
 * Keeps one copy in the original list
